...
export class ContextualActivator {
  ...
  constructor () {
     ...
     */
  public setContextInstantiator<ContextType, InstanceType> (name: string, instantiator: (contextInstace: ContextType, instanceIdentifier: string) => InstanceType): void {
     ...
     */
  public getContextInstantiator<ContextType, InstanceType> (name: string): (contextInstace: ContextType, instanceIdentifier: string) => InstanceType {
