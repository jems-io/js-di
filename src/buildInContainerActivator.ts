 ...
 * @private
 */
export class BuildInContainerActivator implements ContainerActivator {
     ...
     * @param {module:jemsDI.Container} container Represents the container that will use the activator.
