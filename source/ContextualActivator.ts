...
class ContextualActivator {
     ...
     */
    private _instantiators:{ [name:string]:(contextInstace:any, name:string) => any }    
     ...
     * @param {(contextInstace:ContextType, name:string) => InstanceType} instantiator Represents the instantiator that create and return the object.
     */
    setContextInstantiator<ContextType, InstanceType>(name:string, instantiator:(contextInstace:ContextType, name:string) => InstanceType):void {
     ...
     * @param {string} name Represents the name that identify the instantiator.
     * @returns {(contextInstace:ContextType, name:string) => InstanceType} The instantiator that create and return the object.
     */
    getContextInstatiator<ContextType, InstanceType>(name:string):(contextInstace:ContextType, name:string) => InstanceType {
...
export = new ContextualActivator();